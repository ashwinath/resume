...
Financials is a way to track your financial independence in Singapore's context. Inpsired by "Your Money or Your Life" by Vicki Robin. It uses a Grafana frontend to display your current assets, investments, expenditure.
\sectionsep
...
\section{Skills}
\begin{skillList}
    \singleItem{Languages:}{Go, Python, Java, Javascript, Bash, C, Rust, SQL, \LaTeX}
    \\

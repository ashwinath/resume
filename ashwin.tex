...
\begin{bullets}
    ...
    \item Set up and maintain the infrastructure in Data Science Platform such as Prometheus, Knative, KServe, Istio, Kubernetes clusters etc across multiple regions.
...
\begin{bullets}
    \item Developed the backend for \href{https://www.99.co/singapore/new-launches}{\underline{searching based on geospatial data and other data}}.
...
automatically.
    \item Implemented monitoring and alerting systems using Prometheus and Grafana.
